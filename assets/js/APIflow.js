...
let todoList1 = new todoList(root, localstorage.title ="idées/Backlog");
let todoList2 = new todoList(root, title ="A faire");
let todoList3 = new todoList(root, title ="En cours");
let todoList4 = new todoList(root, title ="Réalisé");
